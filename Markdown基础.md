...
## 表格
想让图表居中可以使用`<div class="center"></div>`，详见下方示例。
...
<!-- 通过html代码加标题 -->
<p align="center"><font face="黑体" size=4.>表1 示例表格</font></p> 
<div class="center">
...
## 高级图表 (Mermaid)
需要 Markdown Preview Enhanced 插件支持。
想让图表居中可以使用`<div align="center"></div>`注意空行
### 流程图 (Flowchart)
...
sequenceDiagram
    ...
    participant A as 基站 (gNB)
    participant C as 核心网 (5GC)

    U->>A: RRC Setup Request
    A->>U: RRC Setup
    U->>A: RRC Setup Complete
    A->>C: Initial UE Message
    Note right of C: 5G 注册流程开始
```
